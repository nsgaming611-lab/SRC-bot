...
API_ID = int(os.environ.get("37714867", ""))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("f42fa966dc60ff9f952d5002706424cb", "")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("6154525354", ""))
...
DB_URI = os.environ.get("mongodb+srv://nsgaming611_db_user:4neLNLqiAvjvmkeP@cluster0.0hkdt9x.mongodb.net/?appName=Cluster0", "") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
